...
// Detección de colisión rectángulo contra rectángulo (Axis-Aligned Bounding Box)
bool Colisiones::detectarAABB(const Jugador& a, const Obstaculo& b) {
    if (!b.activo) return false;

    // Hitbox fija del jugador (ajustar si Jugador define su propio ancho/alto)
...
// Indica si un punto (x, y) cae dentro de algún obstáculo activo del escenario
